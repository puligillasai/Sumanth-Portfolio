                     ...
                     <main class="main-area">
                        ...
                        <div class="card-content">
                          ...
                          <div>
                             ...
                             <div>
                               <h4 class= "method">HTML, ReactJS, CSS, JavaScript</h4>
                             </div>
                          </div>
                               ...
                               <div>
                                ...
                                <div>
                                <h4 class="method">JAVA, C,Python</h4>
                                </div>
                                </div>
                          ...
                          <div>
                             ...
                             <div>
                               <h4 class= "method">MySQL, Hive</h4>
                             </div>
                          </div>               
                           <div>
                             <h3 class="tech"> CLOUD</h3>       
                             <div>
                               <h4 class= "method"> AWS, Azure, Google Cloud, Netfliy</h4>
                             </div>
                          </div>                       
                            <div>
                             <h3 class="tech"> OTHERS</h3>       
                             <div>
                               <h4 class= "method">Wordpress, Git</h4>
                             </div>
                          </div>                     
